            ...
            <header id="site-header" dir={isEnglish ? 'ltr' : 'rtl'} className="site-header w-full bg-white">
                        ...
                        <nav ref={desktopMenuRef} aria-label={t('القائمة الرئيسية', 'Main navigation')} className={`main-menu-wrap order-3 hidden min-w-0 items-center gap-0.5 text-sm font-bold text-slate-800 xl:order-2 xl:flex ${desktopMenuAlignmentClass}`}>
                                ...
                                <div className="nav-dropdown-menu nav-dropdown-menu--submenu">
                                    ...
                                    <div className="nav-submenu">
                                        ...
                                        <div className="nav-submenu-menu" role="menu">
                                            ...
                                            <a className="nav-dropdown-item" href={ROUTES.industrialWasteRole}>{t('دور إداره الصرف الصناعي', 'Role of the industrial wastewater department')}</a>
                                        </div>
                                    </div>
                            ...
                            <div className="nav-dropdown group">
                                ...
                                <div className="nav-dropdown-menu">
                                    ...
                                    <a className="nav-dropdown-item" href={ROUTES.schoolSubmissionData}>{t('نتائج المدرسه', 'School results')}</a>
                                </div>
                            </div>
                            ...
                            <div className="nav-dropdown group">
                                ...
                                <div className="nav-dropdown-menu">
                                    <a className="nav-dropdown-item" href={ROUTES.integritySupportOverview}>{t('نبذه عن إداره دعم النزاهة', 'About the integrity support department')}</a>
                            ...
                            <div className="nav-dropdown group">
                                ...
                                <div className="nav-dropdown-menu">
                                    <a className="nav-dropdown-item" href={ROUTES.bossTrips}>{t('جولات رئيس مجلس الإداره', 'Chairman tours')}</a>
                ...
                >
                    <div className="grid grid-cols-1 gap-2">
                        ...
                        <details className="mobile-nav-group"><summary>{t('التدريب', 'Training')}</summary><div className="mobile-nav-submenu"><a href={ROUTES.generalAdminTraining}>{t('أنواع التدريب والقاعات', 'Training types and halls')}</a><a href={ROUTES.schoolSubmissionData}>{t('نتائج المدرسه', 'School results')}</a></div></details>
