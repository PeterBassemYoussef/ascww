        ...
        <header id="site-header" dir={isEnglish ? 'ltr' : 'rtl'} className="site-header w-full bg-white">
                ...
                <div className="mx-auto flex max-w-[1600px] items-center justify-between px-8 py-2 text-sm">
                    <div className="flex items-center gap-6">
                        ...
                        <a href="tel:088-2331604" className="topbar-link">
                            ...
                            <span className="text-xs font-normal">{t('رقم الهاتف : 2331604-088', 'Phone: 2331604-088')}</span>
                        </a>
                    </div>
            ...
            >
                <div className="grid grid-cols-1 gap-2">
                    ...
                    <a className="rounded-lg bg-[#0a3555] px-3 py-2 text-center text-white" href="tel:088-2331604">{t('الخط الساخن : 2331604-088', 'Phone: 2331604-088')}</a>
