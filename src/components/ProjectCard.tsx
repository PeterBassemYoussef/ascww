...
function ProjectCard({ project }: ProjectCardProps) {
    ...
    const metaItemClass = isEnglish ? 'flex max-w-[150px] items-center truncate' : 'flex max-w-[150px] flex-row-reverse items-center truncate';
    const metaIconClass = 'mr-1 h-3 w-3';
    const footerClass = 'project-card-footer mt-auto flex items-center justify-between border-t border-gray-100 pt-4';
    ...
    return (
        <div className="project-card group flex h-full flex-col overflow-hidden rounded-xl border border-gray-100 bg-white shadow-md transition-shadow duration-300 hover:shadow-lg" dir={isEnglish ? 'ltr' : 'rtl'}>
            ...
            <div className="flex flex-1 flex-col p-5">
                ...
                <h3 className={`mb-2 line-clamp-2 text-lg font-bold leading-tight text-gray-900 transition-colors hover:text-blue-600 ${textAlignmentClass}`}>
                    <Link to={projectPath}>{project.title || t('بدون عنوان', 'Untitled')}</Link>
                </h3>
                ...
                <div className={footerClass}>
                    ...
                    <div className="project-card-actions flex gap-2">
                        <button
                            type="button"
                            onClick={(event) => {
